...
xSize = 10; ySize = 7.0; %For APS paper the recomended figure width equals the column width of the paper 8.6 cm (or 2 times 8.6 cm for long figures)
...
%	y(:,m-1)=abs(y(:,m-1).*0.0624);
    h=plot(y(:,m-1),y(:,m),'Linewidth',3);
  end
...
ylimit=get(gca,'ylim');
line([verticallines;verticallines],ylimit,'linewidth',0.5,'color','k','linestyle','-.');
