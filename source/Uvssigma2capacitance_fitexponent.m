...
function Uvssigma2capacitance_error(fitexponent)
...
% Fit routine with specific exponent
%templ='(a*abs(x)^0.5-b)*(1/(1+exp(-C*x) ))';
templ='(a*abs(x)^SED_fitexponent_SED-b)*(1/(1+exp(-C*x) ))';
