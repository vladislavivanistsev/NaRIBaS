...
# Delete replica.list as replicas will be combined
inputlists=(particle.list cation.list anion.list impurity.list temperature.list version.list surfacecharge.list duration_NVT.list numberdens.list)
...
tasks=task_analysis-numberdensity-slab_STEP2.sh
