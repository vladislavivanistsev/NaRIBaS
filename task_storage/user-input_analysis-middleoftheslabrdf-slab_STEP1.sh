...
inputlists=(particle.list cation.list anion.list impurity.list temperature.list version.list surfacecharge.list replica.list duration_NVT.list numberofionpairs.list) #rdf.list
...
tasks=task_analysis-middleoftheslabrdf-slab_STEP1.sh
