...
inputlists=(particle.list cation.list anion.list impurity.list version.list duration_NVT.list numberdens.list layerdata_normalized.list)
...
tasks=task_analysis-ionnumberinlayer-slab_STEP4.sh
