...
sed 's+SED_dir_scripts_SED+'$currentdir'/source+g' $currentdir/source/Uvssigma2capacitance_fitexponent_estimation.m > Uvssigma2capacitance_fitexponent_estimation.m
sed -i 's/SED_file_SED/potentialdrop+'$temperature_name'.dat/g' Uvssigma2capacitance_fitexponent_estimation.m
sed -i 's/SED_savename-smoothpotentialdrop_SED/potentialdrop-smooth+'$temperature_name'+corrected.dat/g' Uvssigma2capacitance_fitexponent_estimation.m
sed -i 's/SED_savename_SED/capacitance+'$temperature_name'+corrected.dat/g' Uvssigma2capacitance_fitexponent_estimation.m

# Run matlab
$matlabdir/matlab -nodisplay -nosplash -r  "Uvssigma2capacitance_fitexponent_estimation()"
