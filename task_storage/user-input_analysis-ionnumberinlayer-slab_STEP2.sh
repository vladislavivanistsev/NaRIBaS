...
inputlists=(particle.list cation.list anion.list impurity.list version.list duration_NVT.list numberdens_ionnumberinlayer.list electrode_ionnumberinlayer.list layerdata.list)
...
tasks=task_analysis-ionnumberinlayer-slab_STEP2.sh
