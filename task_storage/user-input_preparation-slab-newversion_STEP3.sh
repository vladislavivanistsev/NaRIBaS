...
inputlists=(particle.list cation.list anion.list impurity.list temperature.list surfacecharge.list version.list replica.list numberofionpairs.list)

####### Add here the file that contains the task list
tasks=task_preparation-slab-newversion_STEP3.sh
