...
mkdir -p $dir_analysis/$fullpath2simulate/energydistribution/surfacecharge

cd $dir_analysis/$fullpath2simulate/energydistribution/surfacecharge

pwd

plotdata=distr_$temperature_name\_$replica_name.dat
...
fullpath=$particle_name/$cation_name/$anion_name/$impurity_name/$temperature_name/$version_name/$surfacecharge_name/$replica_name
legend=$legend' '$surfacecharge_name' {\itE_{total}}(kJ/mol)'
