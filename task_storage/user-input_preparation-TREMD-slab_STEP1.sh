...
inputlists=(particle.list cation.list anion.list impurity.list temperature_T_REMD.list surfacecharge_T_REMD.list version.list replica.list numberofionpairs.list)

####### Add here the file that contains the task list
tasks=task_preparation-TREMD-slab_STEP1.sh
