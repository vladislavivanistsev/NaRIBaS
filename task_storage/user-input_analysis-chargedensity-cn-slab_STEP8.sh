...
inputlists=(particle.list cation.list anion.list impurity.list version.list duration_NVT.list surfacecharge.list numberdens.list electrode.list)
...
tasks=task_analysis-chargedensity-cn-slab_STEP8.sh
