...
inputlists=(particle.list cation.list anion.list impurity.list version.list duration_NVT.list numberdens.list)
...
tasks=task_analysis-numberdensity-slab_STEP5.sh
