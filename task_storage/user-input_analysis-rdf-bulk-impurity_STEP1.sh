...
inputlists=(particle.list cation.list anion.list impurity.list combination.list replica.list temperature.list version.list boxsize.list duration_NPT.list rdf.list)
...
tasks=task_analysis-rdf-bulk-impurity_STEP1.sh
