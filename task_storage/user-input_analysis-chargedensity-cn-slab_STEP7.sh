...
inputlists=(particle.list cation.list anion.list impurity.list temperature.list version.list duration_NVT.list electrode.list)
...
tasks=task_analysis-chargedensity-cn-slab_STEP7.sh
