...
inputlists=(particle.list cation.list anion.list impurity.list temperature.list version.list duration_NVT.list numberdens.list electrode.list)
...
tasks=task_analysis-cndifferencepeakheight-slab_STEP1.sh
