...
inputlists=(particle.list cation.list anion.list impurity.list temperature.list version.list duration_NVT.list)
...
tasks=task_analysis-potentialdrop-error-slab_STEP3.sh
