...
inputlists=(particle.list cation.list anion.list impurity.list version.list duration_NVT.list surfacecharge.list electrode.list)
...
tasks=task_analysis-chargedensity-cn-slab_STEP9.sh
