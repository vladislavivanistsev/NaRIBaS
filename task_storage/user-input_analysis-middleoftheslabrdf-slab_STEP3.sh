...
inputlists=(particle.list cation.list anion.list impurity.list version.list surfacecharge.list duration_NVT.list rdf.list)
...
tasks=task_analysis-middleoftheslabrdf-slab_STEP3.sh
