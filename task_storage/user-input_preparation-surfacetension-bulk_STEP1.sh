...
inputlists=(particle.list cation.list anion.list impurity.list replica.list temperature.list version.list numberofionpairs.list)

####### Add here the file that contains the task list
tasks=task_preparation-surfacetension-bulk_STEP1.sh
