...
sed -i 's|SED_title_SED|'$numberdens_name'-'$electrode_name' '$temperature_name' K|g' basic_plotting_profile.m
sed -i 's/SED_savename_SED/'$plotdata'/g' basic_plotting_profile.m
sed -i 's/SED_legend_name_SED/\\sigma(\\muC cm^{-2})/g' basic_plotting_profile.m
...
sed -i 's|SED_title_SED|'$numberdens_name'-'$electrode_name' '$temperature_name' K|g' basic_plotting_profile_difference.m
sed -i 's/SED_savename_SED/'$plotdata'+difference/g' basic_plotting_profile_difference.m
sed -i 's/SED_legend_name_SED/\\sigma(\\muC cm^{-2})/g' basic_plotting_profile_difference.m
...
sed -i 's/SED_ylim_SED/-20 40/g' basic_plotting_profile_difference.m # in nm Cation Anode
#sed -i 's/SED_ylim_SED/0 200/g' basic_plotting_profile_difference.m # in nm Anion Anode
#sed -i 's/SED_ylim_SED/0 150/g' basic_plotting_profile_difference.m # in nm Cation Cathode
#sed -i 's/SED_ylim_SED/-80 0/g' basic_plotting_profile_difference.m # in nm Anion Cathode
