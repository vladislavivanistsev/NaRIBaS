...
inputlists=(particle.list cation.list anion.list impurity.list temperature.list version.list surfacecharge.list replica.list duration_NVT.list)
...
tasks=task_analysis-layerscreenshots-slab_STEP1.sh
