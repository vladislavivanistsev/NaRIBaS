...
layerdata_legend=$(echo ${current_layerdata[0]} | awk '{print $2}')
...
sed -i 's/SED_savename_SED/'$plotdata'/g' basic_plotting_profile_long_legendoutside.m

sed -i 's/SED_verticallines_SED/0/g' basic_plotting_profile_long_legendoutside.m # position in nm
sed -i 's/SED_xlim_SED/-7 7/g' basic_plotting_profile_long_legendoutside.m # in nm
