...
inputlists=(particle.list cation.list anion.list impurity.list replica.list version.list surfacecharge.list duration_NVT.list)
...
tasks=task_analysis-energydistribution-slab_STEP4.sh
