...
inputlists_folder=inputlists_surfacetension_NVT

inputlists=(particle.list cation.list anion.list impurity.list replica.list temperature.list version.list numberofionpairs.list duration_NVT.list)

####### Add here the file that contains the task list
tasks=task_analysis-surfacetension-bulk_STEP1.sh
