...
inputlists=(particle.list cation.list anion.list impurity.list combination.list replica.list temperature.list version.list)
...
tasks=task_analysis-vmdsnapshots-bulk-impurity.sh
