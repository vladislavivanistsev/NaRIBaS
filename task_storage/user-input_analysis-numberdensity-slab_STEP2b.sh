...
inputlists=(particle.list cation.list anion.list impurity.list temperature.list version.list surfacecharge.list replica.list numberdens.list)
...
tasks=task_analysis-numberdensity-slab_STEP2b.sh
