...
inputlists=(particle.list cation.list anion.list impurity.list temperature.list version.list duration_NVT.list fitexponent.list)
...
tasks=task_analysis-potentialdrop-error-slab_STEP1.sh
