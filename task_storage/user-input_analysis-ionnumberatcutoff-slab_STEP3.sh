...
inputlists=(particle.list cation.list anion.list impurity.list version.list duration_NVT.list numberdens.list cutoff.list)
...
tasks=task_analysis-ionnumberatcutoff-slab_STEP3.sh
