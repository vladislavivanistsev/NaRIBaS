...
inputlists=(particle.list cation.list anion.list impurity.list temperature.list version.list duration_NVT.list numberdens_ionnumberinlayer.list electrode_ionnumberinlayer.list)
...
tasks=task_analysis-ionnumberinlayer-slab_STEP1.sh
