...
inputlists=(particle.list cation.list anion.list impurity.list version.list duration_NVT.list numberdens.list electrode.list)
...
tasks=task_analysis-cndifferencepeakheight-slab_STEP2.sh
