...
inputlists=(particle.list cation.list anion.list impurity.list version.list duration_NPT.list numberofionpairs.list energy.list)

####### Add here the file that contains the task list
tasks=task_analysis-energy-bulk_STEP2.sh
