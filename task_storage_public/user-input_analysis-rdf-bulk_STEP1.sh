...
inputlists=(particle.list cation.list anion.list impurity.list replica.list temperature.list version.list duration_NVT.list rdf.list)

####### Add here the file that contains the task list
tasks=task_analysis-rdf-bulk_STEP1.sh
